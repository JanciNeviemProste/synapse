...
export const SYSTEM_TEMPLATES: SystemTemplateSeed[] = [
  ...
  },
  {
    ...
    hookPattern: 'Predtým, než podpíšeš [zmluvu], skontroluj si týchto X vecí.',
    bodyPattern: 'Checklist s konkrétnymi miestami v zmluve, kde to nájsť.',
    ctaPattern: 'Pošli tomu, kto práve niečo podpisuje.',
    complianceRules: 'Nejde o právne/finančné poradenstvo — uviesť disclaimer.',
  },
  {
